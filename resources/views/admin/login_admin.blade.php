...
@endif
  ...
  <div class="form-outline mb-4">
    <input type="email" id="form2Example1" name="email" value="{{ Cookie::get('emailadmin'); }}" class="form-control" />
  ...
  <!-- Password input -->
  <div class="form-outline mb-4">
    <input type="password" id="form2Example2" value="{{ Cookie::get('passwordadmin'); }}" name="password" class="form-control" />
